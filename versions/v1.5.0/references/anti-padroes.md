...
> Regra de bolso: se a justificativa começa com "só pra funcionar", "depois eu arrumo" ou "é mais rápido assim" e o resultado mexe em segredo, auth, acessibilidade, performance, registro — **ou toca o site/servidor por fora do fluxo/pipeline** — **provavelmente é uma macaquice desta lista. Para e faz certo.**
