...
**Versão:** skill `schematize-web` v1.0.0. Changelog em `CHANGELOG.md`. Versões de stack e thresholds (que mudam) ficam em `references/stack-versoes.md` (Anexo A), atualizado à parte.
...
- **Layout de referência: a disciplina visual do apple.com** — hierarquia tipográfica forte, respiro generoso, hero de produto, grid preciso, motion contido e com `prefers-reduced-motion`. É **princípio de layout**, não cópia de marca/asset.
